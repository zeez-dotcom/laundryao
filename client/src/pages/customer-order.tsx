        ...
        <Card className="w-full max-w-md">
          <CardContent className="pt-6">
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Invalid QR code. Please scan a valid QR code from one of our branch locations.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
        ...
        <Card className="w-full max-w-md">
          <CardContent className="pt-6">
            <Alert variant="destructive">
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                {error instanceof Error ? error.message : "QR code not found or has expired"}
              </AlertDescription>
            </Alert>
            <div className="mt-4 text-center">
              <p className="text-sm text-muted-foreground mb-3">
                If you believe this is an error, please contact the branch directly.
              </p>
            </div>
          </CardContent>
        </Card>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-4">
      <Card className="w-full max-w-lg">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold">Welcome to {branch.name}</CardTitle>
          <p className="text-muted-foreground">
            You've successfully scanned our QR code! Start your laundry order below.
          </p>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-4 space-y-3">
            <div className="flex items-center space-x-2 text-blue-800 dark:text-blue-200">
              ...
              <span className="font-medium">Branch Information</span>
            </div>
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-lg">Ready to start your order?</h3>
            <p className="text-muted-foreground text-sm">
              Choose how you'd like to proceed with your laundry service:
            </p>
